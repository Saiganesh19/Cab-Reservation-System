...
<div class="up">
<!-- <div class="aboutus"> -->
<div class="wrapper" id="wrap" style="max-width:1000px;">
<div id="">
        <h2 style="text-shadow: 6px 6px 6px white; word-spacing:10px; letter-spacing:2px;" id="hh"><b>GAAP Travels</b></h2>
</div>
        <p align="justify" style="color:solid black; text-algn:center; margin-top:30px; ">Welcome to [GAAP TRAVELS]! Your number one destiny for Car rentals [vehicles, ie: Sedan, SUV, Van]. We're dedicated to giving you the very best of [rental services], with a focus on [three characteristics, ie: dependability, customer service and uniqueness.]
Founded in [2022] by [Jaddu Saiganesh, P.N.V. Vyshnavi, Messaragandla Alekhya, Aditya Joshi], [GAAP TRAVELS] has come a long way from its beginnings in a [starting location, ie: home office, Visakhapatnam, Andhrapradesh, India.]. When we first started out, our passion for [ ie: helping  people be more comfortable to book cars from home and to travel safely, providing the best services for the fellow customers] drove us to [action, ie: be passionate, accountable in rental service industry], and gave us the impetus to turn hard work and inspiration into to a booming online car Rental service. We now serve customers all over , and are thrilled to be a part of the wing of this industry.
We hope you enjoy our services as much as we enjoy providing them to you. If you have any questions or comments, please don't hesitate to contact us [email: gaaptravels@gmail.com].
<wbr><br><br>
Sincerely,<br>
<i>GAAP Travels</i>
</p></div></div>
