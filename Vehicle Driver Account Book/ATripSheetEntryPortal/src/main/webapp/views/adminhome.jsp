...
<div class="up" id="wel">
   <h1 style="font-size:60px;"><b>Welcome to GAAP Travels</b></h1>
   <div style="text-align:center;">
<img src="/views/carr.png" height="300px" width="600px">
</div>
<div>
<p style="font-size:30px; font-style: italic; text-align:center; word-spacing: 18px;  letter-spacing: 3px;  "><i>"Reach Your Destiny"</i></div>
<!--  <div style="text-align:center;">
<h6><i><b>Book the Best Cars for the Best Journey</b></i></h6>
</div>-->
</div>
