...
<tr>
<td>Vehicle</td>
<td><input type="text" name="vehicle" pattern="Van|Sedan|SUV" title="Enter either Van or Sedan or SUV" required/></td>
</tr>

<tr>
<td>Driver</td>
<td><input type="text" name="driver" pattern="[A-Za-z]{3,}" title="Enter atleast 3 letters" required/></td>
</tr>

<tr>
<td>Start Date Time</td>
<td><input type="datetime-local" name="startdatetime" title="Enter dd-mm-yyyy hh:mm" id="start" required/></td>
</tr>

<tr>
<td>End Date Time</td>
<td><input type="datetime-local"  name="enddatetime" title="Enter dd-mm-yyyy hh:mm" id="end" required/></td>
</tr>

<tr>
<td>From Location</td>
<td><input type="text"  name="fromLocation" pattern="[A-Za-z]{3,}" title="Enter atleast 3 letters" required/></td>
</tr>

<tr>
<td>To Location</td>
<td><input type="text"  name="toLocation" pattern="[A-Za-z]{3,}" title="Enter atleast 3 letters" required/></td>
</tr>

<tr>
<td>Distance</td>
<td><input type="number"  name="distance" min="1" max="2000" step="1" title="Enter distance in Km" required/></td>
</tr>

<tr>
<td>Type</td>
<td><input type="text"  name="type" pattern="picup|drop|round|tour" title="picup/drop/round/tour" required/></td>
</tr>
<!-- 
<tr>
<td>Trip Fare</td>
<td><input type="number"  name="tripFare" min="90" max="10000" step="1" title="Enter trip fare" required/></td>
</tr>

<tr>
<td>Fuel Expense</td>
<td><input type="number"  name="fuelExpense"min="50" max="10000" title="Enter fuel expense" required/></td>
</tr>

<tr>
<td>Driver Share</td>
<td><input type="number"  name="driverShare" min="50" max="10000" title="Enter driver share" required/></td>
</tr> -->
<!-- 
<tr>
<td>Remarks</td>
...
<tr id="sub">
<td colspan="2"><input type="submit" value="Add Booking" id="in-sub"></td>
</tr>
</table>
              </form>
              </div>
