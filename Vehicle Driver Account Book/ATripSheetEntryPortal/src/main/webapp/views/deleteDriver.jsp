...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
 ...
 <div class="wrapper" id="wrap">
            <h2 class="h" >DELETE DRIVER</h2>

              <form action="deleteDriver" method="post" id="rs">
              
              
              
License Number: <input type="text"  name="licenseNumber" pattern="[A-Z]{2}[0-9]{2}[A-Z]{1}[0-9]{11}" title="Format must be like TN01X20210000123"required/><br>
<input type="submit" value="Delete Driver" id="in-sub">
