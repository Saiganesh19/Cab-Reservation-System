...
<div class="wrapper" id="wrap">
            <h2 class="h" >DELETE VEHICLE</h2>

              <form action="deletevehicle" method="post" id="rs">
              
              
              
Registration Number: <input type="text"  name="registrationNo" pattern="[A-Z]{2}[0-9]{2}[A-Z]{2}[0-9]{4}" title="Enter input like AA12AA1234" required/><br>
<input type="submit" value="Delete Vehicle" id="in-sub">
