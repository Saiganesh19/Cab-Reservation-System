...
<tr>
<td>Booking Id</td>
<td><input type="number"  name="bookingId" min="1" title="Enter Booking Id" required/> </td>
</tr>
...
<tr>
<td>End Date Time</td>
<td><input type="datetime-local"  name="enddatetime" title="Enter dd-mm-yyyy hh:mm" required/></td>
</tr>
...
<tr id="sub">
<td colspan="2"><input type="submit" value="Update Booking" id="in-sub"></td>
</tr>
</table>
              </form>
              </div>
